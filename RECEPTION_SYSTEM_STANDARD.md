# イベント受付システム — 標準仕様書 v2.0（汎用）

> 本ドキュメントは YC・IKIZAMA の**あらゆるイベント受付**に適用する統一仕様です。
> JIDAI クロージング・鈴木さん誕生日・オルズグルフォーラムなど、
> 全イベントの受付ページをこの仕様に基づいて実装してください。
...
**イベント受付システム（汎用版）** は、あらゆるイベント当日の参加者を効率的に管理するウェブアプリケーションです。

| 項目 | 内容 |
|------|------|
| **対象** | JIDAI・IAPONIA・オルズグル・鈴木さん誕生日など全イベント |
